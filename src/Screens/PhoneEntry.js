...
import {View,Text,TouchableOpacity,Image,TextInput, ActivityIndicator,StyleSheet, BackHandler,Alert} from 'react-native';
...
class PhoneEntry extends React.Component
{
    ...
    componentDidMount()
    {
        ...
        this.props.navigation.addListener('focus', () => {
            this.setState({phone : '', focused : true, valid : false, error : false}, () => this.props.phoneClear());
        }); 
